            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        @foreach($editStd as $value)
                        <form action="{{url('/student-management/update')}}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name='fname' value="{{$value->fatherName}}" />
                                <p class="help-block">{{ ($errors->has('fname')) ? $errors->first('fname') : '' }}</p>
                            </div>
                            <div class="form-group">
                                <label>Mother Name:</label>
                                <input type="text" class="form-control" name='mname' value="{{$value->motherName}}" />
                            ...
                            <div class="form-group">
                                <label>Address</label>
                                <textarea name="addr" class="form-control" rows="3">{{$value->address}}</textarea>
                                <p class="help-block">{{ ($errors->has('addr')) ? $errors->first('addr') : '' }}</p>
                            </div>

                            <div class="form-group">
                                <label>Contact:</label>
                                <input type="text" name='contact' class="form-control" value="{{$value->contact}}" />
                                <p class="help-block">{{ ($errors->has('contact')) ? $errors->first('contact') : '' }}</p>
                            </div>

                            <div class="form-group">
                                <label>Admission Fee:</label>
                                <input type="text" name='afees' class="form-control" value="{{$value->admissionFees}}" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name='dob' class="form-control" id="datepicker" value="{{$value->dob}}" />
                                <p class="help-block">{{ ($errors->has('dob')) ? $errors->first('dob') : '' }}</p>
                            </div>

                            <div class="form-group">
                                <label>Date:</label>
                                <input type="text" name='date' class="form-control" id="datepicker1" value="{{$value->date}}" />
